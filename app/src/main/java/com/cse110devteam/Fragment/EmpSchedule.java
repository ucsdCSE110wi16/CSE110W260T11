...
public class EmpSchedule extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View rootView = inflater.inflate(R.layout.employee_schedule, container, false);
        CalendarView calendarView = (CalendarView) rootView.findViewById(R.id.employee_calendar);
        ListView listView = (ListView) rootView.findViewById(R.id.employee_shift_list);
